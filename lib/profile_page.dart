...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: _getCardList(context, address),
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          print('xxxxxxxxxxxxxxxxxxxxxxx: ${snapshot.stackTrace}');
          return Center(
  ...
  Future<List<ComponentModel>> _getCardList(
      BuildContext context, String address) async {
    List<ComponentModel> componentList = [];
    ZkLoginProvider provider = ZkLoginProvider.getInstance();
    List<String>? components =
        await provider.executeGetUserComponents(context, address);
